import time, os, asyncio, sys, logging, requests
        ...
        while attempts <= MAX_ATTEMPTS + 1:
            try:
                ...
                if attempts >= MAX_ATTEMPTS + 1:
                    ...
                    logger.warning(f'Exception checking if stream is online: {e}. Retrying in 5 seconds. Attempt {attempts}/{MAX_ATTEMPTS}.')
